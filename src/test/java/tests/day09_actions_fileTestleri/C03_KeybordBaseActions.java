...
public class C03_KeybordBaseActions extends TestBase {
    ...
    public void test01(){
        ...
        driver.findElement(By.xpath("//a[@data-testid='open-registration-form-button']")).click();        //3- Ad, soyad, mail ve sifre kutularina deger yazalim ve kaydol tusuna basalim
